...
namespace landuioss\Processing;
...
final class ImageUrlBuilder
{
    ...
    public function waterImg(
        ...
        $waterStr = 'watermark/1/image/' . \landuioss\base64_urlSafeEncode($image) . '/';
    ...
    public function waterText(
        ...
        $waterStr = 'watermark/2/text/'
            . \landuioss\base64_urlSafeEncode($text) . '/font/'
            . \landuioss\base64_urlSafeEncode($font) . '/';
        ...
        if (!is_null($fontColor)
            ...
            $waterStr .= 'fill/' . \landuioss\base64_urlSafeEncode($fontColor) . '/';
        }
