...
class Sms
{
    ...
    public function querySendSms(
        ...
        $query = array();
        \landuioss\setWithoutEmpty($query, 'job_id', $job_id);
        \landuioss\setWithoutEmpty($query, 'message_id', $message_id);
        \landuioss\setWithoutEmpty($query, 'mobile', $mobile);
        \landuioss\setWithoutEmpty($query, 'status', $status);
        \landuioss\setWithoutEmpty($query, 'template_id', $template_id);
        \landuioss\setWithoutEmpty($query, 'type', $type);
        \landuioss\setWithoutEmpty($query, 'start', $start);
        \landuioss\setWithoutEmpty($query, 'end', $end);
        \landuioss\setWithoutEmpty($query, 'page', $page);
        \landuioss\setWithoutEmpty($query, 'page_size', $page_size);
