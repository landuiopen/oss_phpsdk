...
final class CdnManager
{
    ...
    public function getCdnRefreshList(
        ...
        $req = array();
        \landuioss\setWithoutEmpty($req, 'requestId', $requestId);
        \landuioss\setWithoutEmpty($req, 'isDir', $isDir);
        \landuioss\setWithoutEmpty($req, 'urls', $urls);
        \landuioss\setWithoutEmpty($req, 'state', $state);
        \landuioss\setWithoutEmpty($req, 'pageNo', $pageNo);
        \landuioss\setWithoutEmpty($req, 'pageSize', $pageSize);
        \landuioss\setWithoutEmpty($req, 'startTime', $startTime);
        \landuioss\setWithoutEmpty($req, 'endTime', $endTime);
